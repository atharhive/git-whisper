...
class StoryEngine:
    def __init__(self, api_key=None):
        ...
        If api_key is provided, uses it. Otherwise, uses the configured GEMINI_API_KEY.
        """
        if api_key:
            self._api_key = api_key
        else:
            self._api_key = EnvVars.GEMINI_API_KEY
        ...
        self.model = genai.GenerativeModel('gemini-2.5-flash') # type: ignore # Changed model
